...
/>
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-4">
              A statutory body corporate under an Act of Parliament, promoting good corporate governance 
              and developing high calibre professionals.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">About ICSI</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Membership</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Examinations</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Professional Development</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Research & Development</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Training Programs</a></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-sm text-gray-400">
              COPYRIGHT © 2022. ICSI. ALL RIGHTS RESERVED.
            </div>
          </div>
        </div>
      </div>
